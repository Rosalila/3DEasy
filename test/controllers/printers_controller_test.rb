...
class PrintersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create printer" do
    assert_difference('Printer.count') do
      post printers_url, params: { printer: { api_key: @printer.api_key, ip: @printer.ip, name: @printer.name, user_id: @printer.user_id } }
    end
  ...
  test "should update printer" do
    patch printer_url(@printer), params: { printer: { api_key: @printer.api_key, ip: @printer.ip, name: @printer.name, user_id: @printer.user_id } }
