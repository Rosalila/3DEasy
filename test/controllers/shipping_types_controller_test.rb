...
class ShippingTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping_type" do
    assert_difference('ShippingType.count') do
      post shipping_types_url, params: { shipping_type: { doges: @shipping_type.doges, name: @shipping_type.name, printing_hub_id: @shipping_type.printing_hub_id } }
    end
  ...
  test "should update shipping_type" do
    patch shipping_type_url(@shipping_type), params: { shipping_type: { doges: @shipping_type.doges, name: @shipping_type.name, printing_hub_id: @shipping_type.printing_hub_id } }
